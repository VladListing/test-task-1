            ...
            try
          {
               ...
               using (BinaryReader reader = new BinaryReader(File.Open(path, FileMode.Open)))
               {
                    ...
                    while (reader.PeekChar() > -1)// пока не достигнут конец файла
                    {
                        ...
                        trade[schetchik] = new TradeRecord(id, account, volume, comment );// инециализируем поля , присваиваем им значения через конструктор
                        schetchik = schetchik + 1;

                    }
                }

                //==============  конвертируем винарный файл в файл *.CSV  =================================================== 
